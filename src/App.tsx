...
import { Camera as CameraIcon, MapPin, ShoppingBag, Trophy, Fish, Sparkles, Coins, Gift, Waves, Zap, Globe2 } from 'lucide-react';
...
import { FishData, PlayerState, DailyQuest, PassportDestination } from './types';
          ...
          <div className="glass-panel rounded-3xl p-5 relative overflow-hidden">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="hud-button" onClick={() => setShowPassport(true)}>
                  <Globe2 size={16} />
                  Passport
                </button>
              </div>
            ...
            {passportDestination && (
              <div className="hud-pill text-emerald-200 mb-4">
                <Globe2 size={14} className="text-emerald-300" />
                Passport: {passportDestination.label}
              </div>
            )}
